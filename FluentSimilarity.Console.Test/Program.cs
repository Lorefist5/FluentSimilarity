...
foreach (var result in levSimilarityScore.AllResults.Where(p => p.PropertyName.ToLower() == "age"))
{
    Console.WriteLine(result.PropertyName + " and scoring of " + result.Score);
