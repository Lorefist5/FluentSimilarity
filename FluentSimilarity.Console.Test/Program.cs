...
var app = new ServiceCollection().AddScorersFromAssembly(Assembly.GetExecutingAssembly()).BuildServiceProvider();
...
var filtersTestP1 = new Person { FirstName = "Bob", LastName = "S", Age = 40, BirthDate = new DateTime(1983, 3, 10) };
var filtersTestP2 = new Person { FirstName = "Bob", LastName = "Shadi", Age = 40, BirthDate = new DateTime(1983, 3, 10) };
